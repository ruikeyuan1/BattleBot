...
//        } 
//        
//        if(analogRead(leftSensor) >= (BLACK)) { 
//            if(!check) {
//              check = true;
//              goStop(150); 
//            }
...
//        }
//      
//        if(analogRead(rightSensor) >= (BLACK)) {  
//            if(!check) {
//              check = true;
//              goStop(150); 
//            }
...
//        }
//      
//        if(analogRead(leftSensor) < (BLACK) && analogRead(rightSensor) < (BLACK)) {
//            check = false;
//            goForward();
//        }
//      
